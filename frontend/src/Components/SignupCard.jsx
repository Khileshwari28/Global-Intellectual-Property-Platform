...
const SignupCard = () => {
  ...
  return (
    <div className="signup-form-card" style={styles.card}>
      <h2 className="form-title" style={styles.title}>Create Your Account</h2>
      ...
      {/* MODAL (Unchanged logic, just clean styles) */}
      {showLegal && (
        <div style={styles.overlay} onClick={() => setShowLegal(false)}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <h3 style={styles.modalTitle}>Legal Agreements</h3>
              <button onClick={() => setShowLegal(false)} style={styles.closeX}>&times;</button>
            </div>
            
            <div style={styles.scrollArea}>
              <h4 style={styles.sectionTitle}>Terms of Service</h4>
              <p style={styles.p}>By using Global IP, you agree to our search protocols and data management policies.</p>
              <h4 style={styles.sectionTitle}>Privacy Policy</h4>
              <p style={styles.p}>We use industry-standard encryption to protect your account information.</p>
            </div>
...
const styles = {
  card: { 
    ...
    width: '100%',
    maxWidth: '480px', // Proper width for a professional card
    margin: '0 auto',
    display: 'flex',
  ...
  formContainer: {
    width: '100%',
    textAlign: 'left' // Labels will align left
  },
  footerContainer: { 
    marginTop: '24px',
    textAlign: 'center',
  ...
  signInLink: { color: '#2563eb', fontWeight: '600', textDecoration: 'none', marginLeft: '5px' },
  ...
  modal: {
    ...
    padding: '32px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.15)'
  },
  ...
  sectionTitle: { fontSize: '14px', fontWeight: '700', color: '#334155', marginTop: '16px' },
  p: { fontSize: '13px', color: '#64748b', lineHeight: '1.6' },
  doneBtn: { 
    width: '100%', marginTop: '24px', padding: '12px', borderRadius: '12px',
    background: '#1e293b', color: '#fff', border: 'none', fontWeight: '600', cursor: 'pointer' 
  }
};
