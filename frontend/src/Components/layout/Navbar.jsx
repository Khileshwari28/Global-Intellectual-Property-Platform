...
const Navbar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    const notifications = [
        ...
        { id: 2, message: 'Trademark renewal reminder for TM2022/456789', time: '1 day ago', type: 'warning' },
        { id: 3, message: 'New copyright protection added', time: '3 days ago', type: 'info' },
        { id: 4, message: 'Legal status update: Case resolved', time: '1 week ago', type: 'success' }
    ];
